...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-8">
    <h2>{!!trans('admin/shop.title')!!}</h2>
    <ol class="breadcrumb">
        <li>
            <a href="{{url('shop/list')}}">{!!trans('admin/breadcrumb.home')!!}</a>
        </li>
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.shop.list')!!}</strong>
        </li>
    </ol>
  </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">店铺位置</th>
                                ...
                                @foreach ($shops as  $k=>$v)
                                    <tr class="{{$k%2 ? 'odd':'even'}} gradeX"   mrmId="{{ $v->id}}">
                                        ...
                                        <td style=" vertical-align: middle;" class="shoplv">{{ $v->shoplv_name}}</td>
                                        <td align="left" style=" width:20%;" class="address">{{ $v->address_name }}</td>
                                        ...
                                        <td>
                                            <form class="form-inline" role="form">
                                                ...
                                                <a href="/admin/shop/shopsku/{{ $v->id }}" class="btn btn-primary doSelectGoods">查看商品</a>
                        ...
                        <div style="text-align: center;">
                            {!! $shops->appends(['shop_name'=>$search])->links() !!}
                        </div>
